...
#
# Common case: a launchd job spawns a binary; the binary tries to read
# ~/Library/Containers/<app>/Data/...; macOS TCC denies the access because
# the launchd-spawned binary is not in the FDA allowlist.
#
